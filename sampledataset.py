...
all_f115w_images = glob.glob("vela*/file-home-*F115W*_scale.fits")
all_f150w_images = glob.glob("vela*/file-home-*F150W*_scale.fits")
all_f277w_images = glob.glob("vela*/file-home-*F277W*_scale.fits")
all_f444w_images = glob.glob("vela*/file-home-*F444W*_scale.fits")

all_f115w_imagesN = glob.glob("vela*/file-home-*F115W*_scale_noise.fits")
all_f150w_imagesN = glob.glob("vela*/file-home-*F150W*_scale_noise.fits")
all_f277w_imagesN = glob.glob("vela*/file-home-*F277W*_scale_noise.fits")
all_f444w_imagesN = glob.glob("vela*/file-home-*F444W*_scale_noise.fits")
